const translations = {
  en: {
    ...
    usageEyebrow: "Usage",
    usageTitle: "Start with the registry, then let agents follow it.",
    usageIntro:
      "Vibe Ports is a small local contract: humans reserve important ports, agents ask the CLI before starting a service, and the dashboard gives everyone a shared view.",
    usageInitTitle: "Initialize a registry",
    usageInitText: "Create the user-level registry, optionally with sample entries.",
    usageNextTitle: "Find a safe port",
    usageNextText:
      "Ask for the next available port in a rule-based range before starting a service.",
    usageReserveTitle: "Register the decision",
    usageReserveText: "Reserve or assign the port so future coding sessions avoid collisions.",
    usageExportTitle: "Export the dashboard",
    usageExportText: "Generate a static page for local preview or a safe public demo.",
    usageAgentTitle: "For AI agents",
    usageAgentText:
      "Install or copy skills/codex/local-port-registry/SKILL.md, then require agents to run portctl next or portctl check before choosing any PORT.",
  ...
  zh: {
    ...
    metricListening: "运行中",
    usageEyebrow: "用法",
    usageTitle: "先建立端口 registry，再让 agent 按规则执行。",
    usageIntro:
      "Vibe Ports 是一个很小的本地约定：人类预留重要端口，agent 在启动服务前先询问 CLI，网页则给所有人一个共享视图。",
    usageInitTitle: "初始化 registry",
    usageInitText: "创建用户级端口注册表，也可以带上示例条目。",
    usageNextTitle: "查找安全端口",
    usageNextText: "启动服务前，先按类型范围询问下一个可用端口。",
    usageReserveTitle: "登记这次决定",
    usageReserveText: "把端口保留或分配给项目，后续 coding session 就不会撞车。",
    usageExportTitle: "导出网页看板",
    usageExportText: "生成静态页面，用于本地预览，也可以部署成安全的公开 demo。",
    usageAgentTitle: "给 AI agent 使用",
    usageAgentText:
      "安装或复制 skills/codex/local-port-registry/SKILL.md，并要求 agent 在选择任何 PORT 前运行 portctl next 或 portctl check。",
    registryEyebrow: "注册表",
    portsTitle: "端口",
    thPort: "端口",
    thStatus: "状态",
